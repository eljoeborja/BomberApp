...
import entities.Aseguradora;
import jsf.util.JsfUtil;
import jsf.util.JsfUtil.PersistAction;
import entities.session.AseguradoraFacade;
...
public class AseguradoraController implements Serializable {
    ...
    @EJB
    private entities.session.AseguradoraFacade ejbFacade;
    ...
    public Aseguradora getAseguradora(java.lang.String id) {
    ...
    public static class AseguradoraControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Aseguradora) {
                ...
                return getStringKey(o.getAseNit());
            } else {
